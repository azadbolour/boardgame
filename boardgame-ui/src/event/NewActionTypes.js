...
export const startFailure = function(actionType) { return actionType === NewActionTypes.START_FAILURE };

export const startCompletion = function(ok) {
  return ok ? NewActionTypes.START_SUCCESS : NewActionTypes.START_FAILURE;
};